...
public class ScoreBoard extends StackPane
{
	...
	private static final int STARS_X = 105;
	private static final int STARS_Y = 54;

	private static final int COINS_X = 105;
	...
	private void setCoinsCore(int coins) {
		Platform.runLater(() -> { 
			coinsLbl.setText("" +coins); // may add static text too
		});
	}
	...
	private void setStarsCore(int stars) {
		Platform.runLater(() -> { 
			starsLbl.setText("" +stars);  // may add static text too
